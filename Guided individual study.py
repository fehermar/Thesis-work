...
#    rtde_r = RTDEReceive(args.ip, args.frequency)
    rtde_r = rtde_r = rtde_receive.RTDEReceiveInterface("172.16.1.1", args.frequency)
...
rtde_c = rtde_control.RTDEControlInterface("172.16.1.1")
rtde_r = rtde_receive.RTDEReceiveInterface("172.16.1.1")
...
rtde_c.moveL(target, 0.01, 0.2, True)
